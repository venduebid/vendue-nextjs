    ...
    >
      <div className="container mx-auto text-center px-6">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <button className="bg-green-500 hover:bg-green-700 text-white text-md py-3 px-6 rounded-[40px] flex-shrink-0 w-[200px]">
            Join as a collector
          </button>

          <Link to="/join-as-a-celeb">
            <button className="flex justify-center items-center gap-2 bg-white hover:bg-green-700 text-black text-md py-3 px-6 rounded-[40px] flex-shrink-0 w-[200px]">
              Join as a Celeb
