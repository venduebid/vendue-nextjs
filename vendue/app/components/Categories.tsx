  ...
  return (
    <div className="py-8 md:py-16">
      <div className="container mx-auto text-center px-6">
        ...
        <img src='/Line.svg' alt="Divider Line" />
      </div>
      ...
      <div className="flex flex-col justify-center items-center mt-14 bg-[#F7F7F8] px-4 rounded-lg m-0 md:m-16">
        <div className="w-full flex flex-row justify-center items-center gap-6 mt-6">
          <img src='/Wiz.svg"' alt="Wizkid" className="max-w-[150px] h-auto" />
          <img src='/David.svg' alt="David" className="max-w-[150px] h-auto -m-10" />
          <img src='Lionel.svg' alt="Lionel" className="max-w-[150px] h-auto" />
          <img src='/Drake.svg' alt="Drake" className="max-w-[150px] h-auto -m-10" />
          <img src='/Kdot.svg' alt="Kdot" className="max-w-[150px] h-auto" />
        </div>
